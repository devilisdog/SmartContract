<template>
	...
	<view style="width:100%;background-color: white;margin-top:10rpx;">
		<!-- <view class="switch">
			<text>设为销售</text>
			<switch :checked="userData.sale==1" @change="clickSetSwitch($event,0)" color="#FDC830"/>
		</view> -->
		<view class="switch">
			<text>设为代理</text>
			<switch :checked="userData.agent==1" @change="clickSetSwitchdaili($event)" color="#FDC830"/>
		</view>
		<view class="switch">
			<text>设为专家</text>
			<switch :checked="userData.expert==1" @change="clickSetSwitch($event,1)" color="#FDC830"/>
		</view>
		<view class="" v-if="userData.agent==1">
			<view class="switch" @click="goyongprop">
				<text>佣金比例</text>
				<view style="display: flex;align-items: center;">
					<text style="font-size:26rpx;color:#848484">{{userData.rate}}%</text>
					<uni-icons type="forward"></uni-icons>
				</view>
			</view>
			<view class="switch" @click="gojieprop">
				<text>结算天数</text>
				<view style="display: flex;align-items: center;">
					<text style="font-size:26rpx;color:#848484">{{userData.settle_days}}</text>
					<uni-icons type="forward"></uni-icons>
				</view>
			</view>
			<view class="switch" @click="gopage">
				<text>代理数据</text>
				<view style="display: flex;align-items: center;">
					<text style="font-size:26rpx;color:#848484"></text>
					<uni-icons type="forward"></uni-icons>
				</view>
			</view>
		</view>
		<view class="switch" @click="supPage">
			<text>他的邀请</text>
			<view style="display: flex;align-items: center;">
				<text style="font-size:26rpx;color:#848484">{{userData.invitationNumber}}</text>
				<uni-icons type="forward"></uni-icons>
			</view>
		</view>
		...
		<view class="switch" @click="lookSuperior">
			<text>他的上级</text>
			<view style="display: flex;align-items: center;">
				<text style="font-size:26rpx;color:#848484">{{userData.superior.name}}</text>
				<uni-icons type="forward"></uni-icons>
			</view>
		</view>
	</view>
	...
	<uni-popup ref="goyongpopup"   border-radius="20px 20px 20px 20px" >

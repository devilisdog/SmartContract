<template>
	...
	<!-- 头部 -->
	<uni-nav-bar left-text="返回" title="代理数据" @clickRight="clickRight" @clickLeft="clickLeft" />
	<!-- 导航 -->
	<scroll-view scroll-y="true" class="navigation">
		...
		<view class="xiabiao" :style="daohang_value==1 ? 'left:330rpx;'
			: false || daohang_value==2 ?  'left:580rpx;' 
			: false" >
		</view>
	</scroll-view>
	<!-- 内容 -->
	...
	>
		...
		<swiper-item style="display: flex;"><!-- 投注数据 -->
...
<script setup>
	...
	const daohang = reactive(['注册数据', '投注数据', '中奖数据']) //分段器title数据

	...
	<view class="uni-date">
		...
		'uni-date-x--border': border}">
					...
					<view v-if="showClearIcon" class="uni-date__icon-clear" @click.stop="clear">
						<uni-icons type="clear" color="#d8d8d8" size="24"></uni-icons>
					</view>
					<image src="@/static/icon/statistics/sj.png" style="width: 50rpx;height: 50rpx;margin-left: 10rpx;"></image>
				</view>
			</slot>
		</view>
		...
		methods: {
			...
			setEmit(value) {
				...
				if(value[0]==value[1]){
					...
					var starinit=value[0].split('-')
					var endinit=value[1].split('-')
					...
					date_end.setHours(0)
					value[0]=date_star.getFullYear()+'-'+(date_star.getMonth()+1)+'-'+date_star.getDate()
					value[1]=date_end.getFullYear()+'-'+(date_end.getMonth()+1)+'-'+date_end.getDate()
				}

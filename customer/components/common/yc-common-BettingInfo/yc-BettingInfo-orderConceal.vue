	...
	<view class="Card">
		<view style="display: flex;align-items: center;justify-content: space-between;">
			...
			<view style="display: flex;">
				...
				<view v-if="arrInquire(props.xiaoqin.Type)">
					<view class="touguog" style="background-color:#898fff;"
						...
						<text class="tou2" v-for="item,index in xiaoqin.data.remarks.reachType">
							{{xiaoqin.data.type=='北京单场' && index==0?'单关':item}}
						</text>
					</view>
		...
		<view style="height:320rpx;display: flex;align-items: center;justify-content: center;flex-flow: column;">
			<image src="@/static/img/main/lock.png" style="width:150rpx;height:150rpx;"></image>
			<text>开奖后显示投注内容</text>
		</view>
	</view>
...
<style>
	...
	.Card{
		...
		margin: auto;
		padding: 20rpx;
		box-shadow: 0 5rpx 20rpx #e8e8e8;
	}
	.popupCard {
		width: 600rpx;
		height: 300rpx;

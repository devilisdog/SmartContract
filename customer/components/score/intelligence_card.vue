<template>
	<view class="card">
		...
		<view class="big_table_content">
			<view class="home" v-if="Props.cardInfo.homeNews && Props.cardInfo.homeNews.length > 0">
				<view class="home_itme" v-for="itme, index in Props.cardInfo.homeNews">
					<view class="home_top">
						<text style="font-size:28rpx;font-weight: bold;">{{ itme.player_name }}</text>
						<text class="top_label">{{ itme.cause }}</text>
					</view>
					<view class="home_button">
						<text style="font-size:26rpx;color:#959595">{{ itme.reason }}</text>
					</view>
				</view>
			</view>
			...
			<view class="away" v-if="Props.cardInfo.awayNews && Props.cardInfo.awayNews.length > 0">
				<view class="away_itme" v-for="itme, index in Props.cardInfo.awayNews">
					<view class="away_top">
						<text style="font-size:28rpx;font-weight: bold;">{{ itme.player_name }}</text>
						<text class="top_label">{{ itme.cause }}</text>
					</view>

<template>
    <!-- <button @click="sseStart">开始</button>
    <button @click="sseStop">停止</button> -->
    ...
    >
        ...
        <view v-for="(itme, index) in ShowData" :key="itme.id" :id="'item' + itme.createtime">
            <view class="pop_up" v-if="ShowData[index - 1] && getTimeDifferenceInMinutes(ShowData[index - 1].createtime, itme.createtime) > 5">
                {{ dateShowStyle(itme.createtime) }}</view
            >
            ...
            <view class="chat_box_my_image_left" v-else-if="itme.from != counter.user_id && itme.chat_type == 'image'">
                <image :src="itme.user_log" class="logo_style" lazy-load :lazy-load-margin="0" />
...
const ShowData = reactive([
    { id: 'msg-1', content: '这是第 1 条消息', createtime: Math.floor(Date.now() / 1000) - 60, from: 'user_id_1', chat_type: 'text', user_log: 'user_image_1', user_name: '用户1' },
    {
        id: 'msg-2',
        content: '这是第 2 条消息',
        createtime: Math.floor(Date.now() / 1000) - 120,
        from: 'user_id_2',
        chat_type: 'imge',
        user_log: 'user_image_2',
        user_name: '用户2',
    },
    {
        id: 'msg-3',
    ...
    },
    {
        id: 'msg-50',
        content: '这是第 50 条消息',
        createtime: Math.floor(Date.now() / 1000) - 3000,
        from: 'user_id_2',
        chat_type: 'text',
        user_log: 'user_image_2',
        user_name: '用户2',

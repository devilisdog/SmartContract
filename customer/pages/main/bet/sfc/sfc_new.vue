<template>
	...
	<!-- 导航栏 -->
	<uni-nav-bar background-color="#f04b49" @clickLeft="back" height="100rpx" color="#fff" left-icon="left" mark="false">
...
<script setup>
	...
	onBeforeMount(()=>{
		...
		uni.request({//获取比赛数据(任选九)
			url:uni.getStorageSync('dataapi')+'/api.SportDataV1/odds?type=sfc&key=yabokj&secret=33ee2210341c057c2638bc3dfc90dfa7',
			timeout:5000,
			method:'GET',
			success(res){

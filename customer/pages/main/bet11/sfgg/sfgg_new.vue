<template>
	<view class="navigation">
		...
		<view style="height: 100rpx;display: flex;align-items: center;justify-content: center;background-color: #202736; ">
...
<script setup>
	...
	const Getbjdcdata=()=>{//获取比赛数据并处理数据格式
		...
		DataList.value = {}
		uni.request({//获取比赛数据
			url:'https://data.uniapp8.top/api.SportDataV1/odds?type=sfgg&key=qhkj&secret=a4f71eaa25a00144c35eb0a457e636c',
			method:'POST',
			success(res){
				uni.hideLoading()

<template>
	...
	<view class="topBox">
		...
		<view class="content_box" >
			<view class="box_left">
				...
				<uni-notice-bar :text="pageData.homeTeamName" color="#fff" :speed="50" backgroundColor="rgba(0,0,0,0.0)" :scrollable="true"/>
			</view>
			...
			<view class="box_right">
				...
				<uni-notice-bar :text="pageData.awayTeamName" color="#fff" :speed="50" backgroundColor="rgba(0,0,0,0.0)" :scrollable="true"/>
			</view>
		</view>
	</view>
	...
	<scroll-view scroll-y="true" v-show="current === 0" class="bottom_content_box">
		<historyCard @getData="getTeamBoutExploits()" :cardInfo="cardData.history" :currentIndex="current" :myCurrent="0" :type='Props.gameType'></historyCard>
	</scroll-view>
	
	<view class="bottom_content_box" v-show="current === 1">
		<z-paging ref="blvRef" v-model="cardData.blvData_list" @query="getOneMatchEuropeOdds" :fixed="false" :auto="false">
	...
	<scroll-view scroll-y="true" v-show="current === 2" class="bottom_content_box">
		<teamSatetCard @getData="getGameTeamStatus()" :cardInfo="cardData.teamState" :currentIndex="current" :myCurrent="2" :type='Props.gameType'></teamSatetCard>
	</scroll-view>
	...
	<uni-transition :show="isDom || video_show" mode-class="fade" class="close_live" @click="isDom=false;video_show=false;autoPageData()">

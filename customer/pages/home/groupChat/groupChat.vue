<template>
	...
	<uni-popup ref="moreFunc" type="bottom" :mask-click="true">
		<view class="more-func-box" :style="{height: inputLoc+'px'}">
			...
			<view class="func-item" @click="sendRedPacket">
...
<script setup>
	import {onBeforeMount,ref,reactive,getCurrentInstance,defineProps,watch,nextTick} from 'vue';
	...
	const inputLoc=ref(200)//输入框距离底部高度

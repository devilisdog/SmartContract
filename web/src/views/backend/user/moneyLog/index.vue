<template>
    <div class="default-main ba-table-box">
        ...
        <!-- 表格顶部菜单 -->
        <TableHeader :buttons="['refresh', 'comSearch', 'quickSearch', 'columnDisplay']" :quick-search-placeholder="
    ...
    const baTable = new baTableClass(
        new baTableApi(url),
        {
            column: [
                ...
                { label: t('user.moneyLog.type'), prop: 'type', align: 'center', render: 'tags', operator: 'eq', sortable: false, replaceValue: { '0': t('user.moneyLog.type 0'), '1': t('user.moneyLog.type 1'), '2': t('user.moneyLog.type 2'), '3': t('user.moneyLog.type 3'), '4': t('user.moneyLog.type 4'), '5': t('user.moneyLog.type 5') } },
